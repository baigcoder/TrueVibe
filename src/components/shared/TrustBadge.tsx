                ...
                {showDetails && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed sm:absolute left-2 right-2 bottom-20 sm:bottom-auto sm:inset-x-auto sm:left-0 sm:top-full sm:mt-1 z-[9999] sm:w-[220px] origin-bottom sm:origin-top-left sm:px-0 pb-safe sm:pb-0"
                        >
                            {/* Main Panel */}
